...
Revision ID: 00088b24b798
Revises: 44144b8f13ad
Create Date: 2023-04-07 22:44:28.024768
...
revision = '00088b24b798'
down_revision = '44144b8f13ad'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.Column('id', sa.INTEGER(), server_default=sa.text("nextval('institutions_id_seq'::regclass)"), autoincrement=True, nullable=False),
    ...
    sa.Column('id', sa.INTEGER(), server_default=sa.text("nextval('verification_methods_id_seq'::regclass)"), autoincrement=True, nullable=False),
