...
def lambda_handler(event, context):
    ...
    if event["Records"][0]["eventName"] == "INSERT":
        ...
        body = f"""Please use this 6 digits OTP code to verify your login at StudyHub<br>
            {otp}
        """

        message = {
            "Subject": {
                "Data": "Your OTP verification code will be valid for only 10 minutes!"
            },
            "Body": {"HTML": {"Data": body}},
        }

        response = client.send_email(
            Source="duykhang2302@gmail.com",
            Destination={"ToAddresses": [mail_id]},
            Message=message,
        )
